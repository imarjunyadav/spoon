...
- [ ] 1. Set up Redis infrastructure
  - [x] 1.1 Install ioredis package
    - Run `npm install ioredis`
    - _Requirements: 1.1, 5.1_

  - [x] 1.2 Create Redis client service (`backend/services/redisClient.js`)
  ...
  - [x] 1.3 Update .env.example with Redis configuration
    - Add REDIS_URL variable
    - Add REDIS_PASSWORD (optional)
    - _Requirements: 5.1_

- [x] 2. Create Redis-based OTP Store
  - [x] 2.1 Create Redis OTP Store (`backend/services/redisOtpStore.js`)
  ...
  - [x] 2.2 Write property tests for Redis OTP Store
...
- [ ] 3. Create Supabase User Service
  ...
  - [x] 3.3 Write property tests for User Service
    - **Property 3: User Creation with Required Fields**
    - **Property 4: User Lookup Round-Trip**
    - **Validates: Requirements 3.1, 3.2, 3.3, 3.5**

- [x] 4. Update Auth Routes for Production
  - [x] 4.1 Update auth.js to use Redis OTP Store
  ...
  - [x] 4.2 Add signup endpoint to auth.js
  ...
  - [x] 4.3 Update verify-otp endpoint
  ...
  - [x] 4.4 Write property test for email failure handling
    - **Property 5: Email Failure Prevents OTP Storage**
    - **Validates: Requirements 4.3**

- [x] 5. Create Health Check Endpoint
  - [x] 5.1 Create health routes (`backend/routes/health.js`)
  ...
  - [x] 5.2 Register health routes in server.js
    - Add `app.use("/api/health", healthRoutes)`
    - _Requirements: 5.2_

- [x] 6. Update Frontend for Supabase Users
  - [x] 6.1 Update signup.js to call backend
  ...
  - [x] 6.2 Update otp.js to handle user data
