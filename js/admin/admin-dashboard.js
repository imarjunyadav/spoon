...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function render() {
        ...
        if (remainingOrders.length > 0) {
            ...
            dom.btnQueue.innerHTML = `<span style="font-size: 15px; font-weight: 700; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 1px;">QUEUE <span style="font-size: 18px; font-weight: 800; color: var(--text-primary); margin-left: 4px;">${remainingOrders.length}<span style="font-size: 14px; margin-left: 1px;">&times;</span></span></span>`;
