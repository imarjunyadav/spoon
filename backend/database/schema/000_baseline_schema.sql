...
-- STUDENT/USER push devices (kept separate from admin push_subscriptions so the
-- admin "new order" broadcast never reaches users). See migration
-- 20260713_user_push_subscriptions.sql. RLS enabled; backend service role only.
