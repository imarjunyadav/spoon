...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function render() {
        ...
        if (remainingOrders.length > 0) {
            ...
            dom.btnQueue.innerHTML = `<span style="font-size: 15px; font-weight: 700; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 1px;">QUEUE <span style="font-size: 24px; font-weight: 800; color: var(--text-primary); margin-left: 6px;"><span style="font-size: 16px; margin-right: 2px; color: var(--text-secondary);">x</span>${remainingOrders.length}</span></span>`;
